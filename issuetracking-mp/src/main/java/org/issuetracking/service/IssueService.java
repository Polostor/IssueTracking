...
public class IssueService extends GenericIssueServiceInterface {
    ...
    @AllowedUser(id1Method = "getAssignee().getId()")
    ...
    @Length(min = 4, max = 40, param1 = "", input = "Name") // param1 is a issue.getName().length()
    @Length(min = 10, max = 200, param1 = "", input = "Description")
